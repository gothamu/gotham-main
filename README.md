# gotham-main
[![Published on npm](https://img.shields.io/npm/v/@gotham/gotham-main.svg?style=flat)](https://www.npmjs.com/package/@gotham/gotham-main)
[![Build Status](https://travis-ci.org/gothamu/gotham-main.svg?branch=master)](https://travis-ci.org/gothamu/gotham-main)
[![Dependency Status](https://img.shields.io/david/gothamu/gotham-main.svg?style=flat)](https://david-dm.org/gothamu/gotham-main)
[![Published on webcomponents.org](https://img.shields.io/badge/webcomponents.org-published-blue.svg)](https://www.webcomponents.org/author/gothamu)
Welcome to the gotham-main project!
Web component library for Gotham University.
## Quick-start
...
```bash
$ git clone git@github.com:gothamu/gotham-main.git
$ cd gotham-main
$ yarn install
$ yarn start
```
...
- `$ yarn test`
    -  Run tests on ALL gotham-main.
- `$ yarn run build`
    -  Run build on ALL gotham-main.
- `$ yarn run storybook`
    - Run storybook
- `$ yarn run build-storybook`
    - Build storybook for deployment
- `$ lerna publish`
    - Publish ALL gotham-main' elements to npmjs.com
...
To test all gotham-main, run `yarn test` from the root of the repo. If you only want to test the web component you're working on:
...
Then open the URL that will be printed in the terminal. It looks something like this: `http://localhost:8081/components/@@gotham/gotham-main/generated-index.html?cli_browser_id=0`.

## Storybook

We've added [Storybook](https://storybook.js.org/) to gotham-main as a way to preview our web components as they are being developed. We'll also use Storybook to export a static site that will be the demo site for gotham-main.
...
```js
"../../whatwg-fetch/fetch.js": path.join( // this is the third-party dependency in the gotham-main
  __dirname,
